...
final class EngineTest extends TestCase
{
    ...
    protected function tearDown(): void
    {
        ...
        foreach (glob($this->dir . '/partials/*.php') ?: [] as $f) { unlink($f); }
        foreach (glob($this->dir . '/layouts/*.php') ?: [] as $f) { unlink($f); }
        foreach (glob($this->dir . '/../storage/views/*.php') ?: [] as $f) { unlink($f); }
    ...
    public function testFiltersUpperTrim(): void
    {
    ...
    public function testIncludeInheritsData(): void
    {
    ...
    public function testIncludeExplicitData(): void
    {
        $this->tpl('partials/nav.php', '<nav>{{ $title }}</nav>');
    ...
    public function testLayoutExtendsSectionYieldContent(): void
    {
    ...
    public function testNestedIfForeachWithCount(): void
    {
    ...
    public function testCacheDirCreated(): void
    {
        $this->tpl('escape.php', '<p>{{ $name }}</p>');
    ...
    public function testCompilerResolvesElseifInline(): void
    {
